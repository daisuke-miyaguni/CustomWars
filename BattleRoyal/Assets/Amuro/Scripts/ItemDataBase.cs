...
public class ItemDataBase : MonoBehaviour
{
    ...
    void Awake()        //アイテムの作成(アイテム画像、アイテム名、アイテムタイプ、アイテム説明、アイテム攻撃力、アイテム防御力、使用アイテム判別)
    {
        ...
        itemLists[4] = new ItemData(4, Resources.Load("show",      typeof(Sprite)) as Sprite, "救急箱（大）",   MyItemStatus.Item.ball,   "回復（大）", recoveryPower2, 0.0f, 0.0f,    PocketStatus.Pocket.ball_p);
